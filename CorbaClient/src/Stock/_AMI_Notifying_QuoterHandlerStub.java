...
public class _AMI_Notifying_QuoterHandlerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements Stock.AMI_Notifying_QuoterHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = Stock.AMI_Notifying_QuoterHandlerOperations.class;
	public void register_callback_name()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			AMI_Notifying_QuoterHandlerOperations _localServant = (AMI_Notifying_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.register_callback_name();
	...
	public void register_callback_name_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "register_callback_name_excep", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "register_callback_name_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Notifying_QuoterHandlerOperations _localServant = (AMI_Notifying_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.register_callback_name_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void unregister_callback_name_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "unregister_callback_name_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "unregister_callback_name_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Notifying_QuoterHandlerOperations _localServant = (AMI_Notifying_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.unregister_callback_name_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void unregister_callback_name()
	{
		...
		else
		{
			...
			try
			{
				_localServant.unregister_callback_name();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
