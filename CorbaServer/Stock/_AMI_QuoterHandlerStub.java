...
public class _AMI_QuoterHandlerStub
	...
	implements Stock.AMI_QuoterHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = Stock.AMI_QuoterHandlerOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					Stock.StockQuoteHelper.write(_os,ami_return_val);
					_is = _invoke(_os);
					return;
				}
