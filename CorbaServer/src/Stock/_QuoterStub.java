	...
	implements Stock.Quoter
{
	...
	public final static java.lang.Class _opsClass = Stock.QuoterOperations.class;
...
_os.write_string( tmpResult5 );
	...
	public void sendc_getQuoteById(AMI_QuoterHandler ami_handler, int stockId)
	{
		while(true)
		{
			try
