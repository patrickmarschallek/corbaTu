	...
	implements Stock.AMI_Notifying_QuoterHandler
{
	...
	public void unregister_callback_id()
	{
		...
		else
		{
			...
			try
			{
				_localServant.unregister_callback_id();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void register_callback_id_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "register_callback_id_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "register_callback_id_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Notifying_QuoterHandlerOperations _localServant = (AMI_Notifying_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.register_callback_id_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void register_callback_id()
	{
		...
		else
		{
			...
			try
			{
				_localServant.register_callback_id();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void unregister_callback_id_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "unregister_callback_id_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "unregister_callback_id_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Notifying_QuoterHandlerOperations _localServant = (AMI_Notifying_QuoterHandlerOperations)_so.servant;
			try
			{
				_localServant.unregister_callback_id_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
