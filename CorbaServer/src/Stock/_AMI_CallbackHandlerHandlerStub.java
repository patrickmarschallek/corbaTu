...
public class _AMI_CallbackHandlerHandlerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements Stock.AMI_CallbackHandlerHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = Stock.AMI_CallbackHandlerHandlerOperations.class;
	public void push()
	{
		while(true)
		{
		...
		else
		{
			...
			if( _so == null )
				continue;
			AMI_CallbackHandlerHandlerOperations _localServant = (AMI_CallbackHandlerHandlerOperations)_so.servant;
			try
			{
				_localServant.push();
	...
	public void push_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "push_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_CallbackHandlerHandlerOperations _localServant = (AMI_CallbackHandlerHandlerOperations)_so.servant;
			try
			{
				_localServant.push_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
